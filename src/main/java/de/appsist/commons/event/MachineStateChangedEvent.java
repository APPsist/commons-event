    ...
    extends AppsistEvent
{
     ...
     * 
     * @param id
     *            ID for the event instance.
     * @param sessionId
     *            ID of the user who logged in.
     * @param userId
     *            ID of the user who logged in.
     * @param deviceId
     *            ID of the device the user logged in with.
     */
    public MachineStateChangedEvent(String id, String sessionId, String machineId, String stationId,
 ...
 String stationId,
            String severityLevel, ArrayList<String> machineState, String errorTag)
    {
        super(id, MODEL_ID, Type.SERVICE);
		setSessionId(sessionId);
		getPayload().put("machineId", machineId);
    ...
    {
        Object machineStateObject = getPayload().get("machineState");
        if (machineStateObject instanceof ArrayList) {
            ArrayList machineStateArrayList = (ArrayList) machineStateObject;
            return machineStateArrayList.toString();
        }
        return (String) machineStateObject;
    }
