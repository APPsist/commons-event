...
public class AppsistEvent {
	 ...
	 */
	public AppsistEvent(Map<String, Object> content, Type type) throws IllegalArgumentException {
	 ...
	 * @param type Type of the event.
	 */
	public AppsistEvent(String id, String modelId, Type type) {
	 ...
	 */
	public AppsistEvent(String id, String modelId, Type type, Map<String, Object> payload) {
