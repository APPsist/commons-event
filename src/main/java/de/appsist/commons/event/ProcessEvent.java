 ...
 */
public abstract class ProcessEvent extends AppsistEvent {
	...
	/**
	 * Returns the root process of the process tree.
	 * @return Identifier of the root process.
	 */
	public String getRootProcessId() {
		return (String) super.getPayload().get("rootProcessId");
	}
	
	/**
	 * Sets the root process of the process tree.
	 * @param rootProcessId Identifier of the root process.
	 */
	public void setRootProcessId(String rootProcessId) {
		super.getPayload().put("rootProcessId", rootProcessId);
	}
}
