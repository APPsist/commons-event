...
/**
 * Event generated when a process instance has reached a end event of type "terminate".
 * The complete process instance tree is terminated when this event occurs.
 * @author simon.schwantzer(at)im-c.de
 */
public class ProcessTerminateEvent extends ProcessEvent {
	public static final String MODEL_ID = "processEvent:processTerminated";
	 ...
	 */
	public ProcessTerminateEvent(Map<String, Object> content) {
		super(content);
	}
	 ...
	 */
	public ProcessTerminateEvent(String id, String processId, String processInstanceId) {
